...
from modules.otp.functions import generate_otp, \
    hash_function, truncate_otp
...
class Test(TestCase):
    ...
    def test_hash_function(self):
        ...
        self.assertTrue(hash_function("hello", 1234),
                        msg="parameters should be str")

    def test_truncate_otp(self):
        self.assertEqual("039319",
                         truncate_otp("364039319", expected_length=6))
